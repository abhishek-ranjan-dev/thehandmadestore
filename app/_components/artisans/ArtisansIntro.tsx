export function ArtisansIntro() {
  return (
    ...
    >
      <div className="mx-auto grid w-full max-w-7xl grid-cols-1 gap-8 px-5 py-14 sm:gap-10 sm:px-6 sm:py-16 md:grid-cols-12 md:gap-16 md:px-10 md:py-28">
        ...
        <div className="flex flex-col justify-center md:col-span-7">
          ...
          <div aria-hidden className="mt-6 h-px w-16 bg-ths-ink/25 sm:mt-8" />
          <p className="mt-6 text-sm leading-relaxed text-ths-ink/65 sm:mt-8 md:text-base">
